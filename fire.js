...
var bigbooms = [];
lovenum=0;
function lovetimenum(a,b){
if(lovenum>=b){lovenum=1;return 0;}
if(lovenum==a){lovenum=lovenum+1;return 0;}else{
lovenum=lovenum+1;
return lovenum-1;
}
}
    ...
    if (newTime - lastTime > 500 + (window.innerHeight - 767) / 2) {
        ...
        if (random) {
            ...
            var bigboom = new Boom(getRandom(canvas.width / 3, canvas.width * 2 / 3), 2, "#FFF", {
                ...
                document.querySelectorAll(".shape")[parseInt(lovetimenum(0,document.querySelectorAll(".shape").length))]);
            bigbooms.push(bigboom)
        }
        lastTime = newTime;
